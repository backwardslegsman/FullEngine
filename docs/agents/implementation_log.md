...
This is the historical roadmap/changelog archive. It preserves detailed
completed-slice context that used to live in `roadmap.md`.

Do not read this file by default at the start of a task. Use
`docs/agents/roadmap.md` for current priorities and open this archive only
when an older implementation detail, chronology, or provenance question
requires it.

---

# Archived Renderer Roadmap
